...
- Все НПЦ и Компаньоны, когда отравлены, могут применять антидот (если он есть у них в инвентаре). Работает как в бою, так и вне боя и даже при перемещении по глобальной карте и во время отдыха.
