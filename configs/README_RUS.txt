...
- Теперь книги навыков могут примерятся к разумным спутникам, для повышения соответсвующих навыков. Бонус от прочтения книг сохраняется при повышении уровня спутнка.
- Оригинальную формулу получения бонуса к навыку(и его максимальное значение) от прочтения книги можно как увеличить, так и изменить на фиксированое значение.
...
#если файл "books.ini" отсутсвтует по пути "..\Fallout 2 (or other game)\sfall\", то его можно скачать от сюда (https://gitflic.ru/project/fakelshub/sfall/blob?file=config_files%2Fbooks.ini) или ещё от куда :)
# и расположить его по пути "..\Fallout2(или другая игра)\sfall\books.ini"
