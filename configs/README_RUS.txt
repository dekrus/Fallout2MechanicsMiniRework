...
- Все НПЦ и Компаньоны, когда отравлены, могут применять антидот (или стимуляторы), если. Работает как в бою, так и вне боя и даже при перемещении по глобальной карте и во время отдыха.
