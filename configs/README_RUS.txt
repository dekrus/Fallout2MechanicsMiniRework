...
- Распаковать архив в основной каталог игры. F2MechanicsMiniRework требует sfall (`ddraw.dll`) версии 4.1.3+ он поставляется с модом. Если у вас более новая версия, вам не нужно перезаписывать dll при распаковке архива. 
