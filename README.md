...
[__Download__](https://github.com/dekrus/Fallout2MechanicsMiniRework/releases)
 ...
 [__Описание на русском__](https://github.com/dekrus/Fallout2MechanicsMiniRework/blob/main/README_RU.md)
...
**Toughness** (2 ranks):
- Each rank adds +10% damage resistance to all damage types.
...
- Regen mod only: Own fire still deals damage but leaves no burns.
...
Don't forget to uncomment 'BooksFile=sfall\Books.ini' in ddraw.ini and put the file in the right place!
